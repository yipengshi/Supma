...
<title><%=CommonWenZi.SiteName %> - 新超市注册</title>
				...
				<div class="dl-con" id="regist">
					<form id="formpersonal"  name ="formpersonal" method="post" onsubmit="return false;">
						<div class="form">
							...
							<div class="item">
								<span class="label">联系人固定电话号码：</span>
							...
							<div class="item">
								...
								<div class="fl">
								        ...
								        <label for="user_notuser2" onmouseover="document.getElementById('user_notuser2').style.display='block';" class="file1"  >选择照片...</label>
								        <input type="file" onchange="document.getElementById('viewfile').value=this.value;this.style.display='none';document.getElementById('viewfile').focus();" class="file" id="user_notuser2"  name="user_notuser2"'  tabindex="<%=tabindex++ %>"  />
							...
							<div class="item">
								<span class="label">※超市所在片区：</span>
								<input type="hidden" name="u_area" id="u_area"  value=""/>
								<div class="fl">
								<span class="span">
									<input type="text" id="user_address2" name="user_address2" class="inputstyle "  style="width:310px;background-color:#ffffff;color:#8B7D6B;"  readonly="readonly"  value="请认真选择您的超市所在片区，以便为您正确送货"  />
								</span>	
									<label  onclick="JavaScript:window.open('userarea.aspx','','directorys=no,toolbar=no,status=no,menubar=no,scrollbars=yes,resizable=no,width=920,height=500,top=175,left=160');" class="file2"  tabindex="<%=tabindex++ %>">选择片区...</label>										
				...
				<div class="item">
						...
						<!--item end-->
							...
							<div class="item">
								...
								<div class="fl">
									<input type="checkbox" name="" id="xieyi" value=""  /><label class="blue" for="xieyi"  tabindex="<%=tabindex++ %>" >&nbsp;自愿遵守<%=supma.common.CommonWenZi.SiteName %>服务协议</label>
