...
<%session.setAttribute("loginUserInfo",null) ; //注册成功后，把原来的session信息清空%>
...
<title><%=CommonWenZi.SiteName %> -注册成功</title>
<meta http-equiv="x-ua-compatible" content="ie=Edge" />
<meta name="keywords" content="<%=CommonWenZi.SiteName %> -注册成功" />
<meta name="description" content="<%=CommonWenZi.regist_success_meta_description %>" />
		...
		<div id="s_bd">
			...
			<div class="dl_zc">
				...
				<div class="dl_zc_title">
					<h2 class="f_l">注册成功</h2>
					<div class="rt_bg f_r"></div>
				</div>
				<div class="dl-con" id="regist">	
					<img src="images/regist_ok.png" border="0" />
					<strong><span style="font-size: 22px;color:#DC143C"">恭喜！</span>
					<span style="font-size: 14px;color:#FF3030">您已成功注册。请等待3-5个工作日审核通过后，即可</span><u><a href="login.aspx"><span style="font-size: 16px;color:#DC143C">登录</span></a></u><span style="font-size: 14px;color:#FF3030"><%=CommonWenZi.SiteName %>!</span></strong>
					<br />
