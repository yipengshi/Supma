...
<%@page import="supma.beans.*"%>
	...
	<div id="s_ftw">
		...
		<div class="ft_quicklinks">
			<div class="ftql cf">
				<ul>
					...
					<li class="ftql_s">
						<h3>关于<%=CommonWenZi.SiteName %></h3>
						<ul>
							<li><a href=""><%=CommonWenZi.SiteName %>介绍</a></li>
							<li><a href="">团队</a></li>
							<li><a href="">媒体报道</a></li>
							<li><a href="">招纳贤士</a></li>
							<li><a href="">公告</a></li>
					...
					<li class="ftql_s">
						<div class="ftql_d">
							...
							<div class="val"><a href="mailto:<%=CommonWenZi.Fuwu_MAIL %>"><%=CommonWenZi.Fuwu_MAIL %></a></div>
						</div>
						<div class="ftql_d">
							<div class="str">客服中心热线：</div>
							<div class="val stel"><%=CommonWenZi.Fuwu_TEL %></div>
						</div>
					</li>
				</ul>
			</div>
		...
		<div id="s_ft">
			<div class="ft_suggest pt100">请帮助我们提高！<a href="#">网站首页意见反馈</a></div>
			...
			<div class="copyright tac pbt10">版权所有 Copyright&copy; <%=CommonWenZi.SiteName %> All Rights Reserved 版权所有 </div>
