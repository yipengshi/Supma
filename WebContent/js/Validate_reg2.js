...
var validatePrompt = {
    ...
    userallname:{
        ...
        isNull:"请输入超市全名。",
        error:{
            beUsed:"该批发商全名已被使用，请使用其他名称注册。",
            badLength:"批发商全名长度只能40位以内字符。",
            badFormat:"批发商全名只能由中文、英文、数字及“_”、“-”组成。"
        }
    },
    pwd:{
    ...
    telno:{
        ...
        succeed:"",
        isNull:"请输入固定电话号码。例:020-89888888。",
        error:{
    ...
    u_area:{
        onFocus:"请选择您的可送货片区（可多选,最多选100个片区）",
        succeed:"",
        isNull:"请选择您的可送货片区（可多选,最多选100个片区）",
        error:""
    },
    u_goodstype:{
        onFocus:"请选择您的可送货商品种类（可多选,最多选15个种类）",
        succeed:"",
        isNull:"请选择您的可送货商品种类（可多选,最多选15个种类）",
        error:""
    },
    user_address1:{
        onFocus:"80个字符以内，可由中文、英文、数字及“_”、“-”组成。",
        succeed:"",
        isNull:"请输入批发商公司地址，以便我们确认您的资质。",
        error:{
            badLength:"公司地址长度只能80位以内字符。",
