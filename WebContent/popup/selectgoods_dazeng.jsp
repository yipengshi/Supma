...
function getArguments() {
	...
	document.getElementById("callPage").value=obj.value;
...
//这个是直接关窗口×的方法，现在什么也不做<body onunload>
  ...
  %>
<body onload='selectTab03Syn(1,<%=newtypeList.size()%>);getArguments();'  onunload="windowclose();">
   ...
   <%
    ...
    %>
        			...
        			<b><font color="#104E8B">清除你的选择</font></b>
   				   ...
   				   <input type="hidden" id="callPage"  value="" />
</div>
